...
public class DeliverOrdersAdapter extends BaseExpandableListAdapter
{
    ...
    public DeliverOrdersAdapter(Activity context, ArrayList<Orders> orders)
    {
...
//on payment floating button clicked
    ...
    class ViewGroupHolder
    {
        ...
        {
            orderId    =   view.findViewById(R.id.deliverOrder_txtOrderNo);
            date       =   view.findViewById(R.id.deliverOrder_txtCustomerName);
