...
public class OrdersAdapter extends RecyclerView.Adapter<OrdersAdapter.ViewHolder>
{
    ...
    public OrdersAdapter(Context context,ArrayList<OrderItems> orderItems)
    {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, int position)
    {
        ...
        viewHolder.qtyOrdered.setText(orders.getQty());
        viewHolder.unitPrice.setText(orders.getUnitPrice());
        viewHolder.status.setChecked(orders.getDelivered());

       //Checkbox activities
         viewHolder.status.setOnCheckedChangeListener(null);
         viewHolder.status.setChecked(orderItems.get(position).getDelivered());
