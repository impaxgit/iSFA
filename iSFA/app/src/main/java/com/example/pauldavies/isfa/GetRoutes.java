...
{
    Context context;
    private ArrayList<Journey> routePlans;
    private HttpURLConnection conn;
    private URL url;
    AsyncTaskDelegate delegate;

    public GetRoutes(ArrayList<Journey> routePlans, Context context,  AsyncTaskDelegate delegate)
    {
    ...
    protected String doInBackground(String... params)
    {
        try
        {
            url = new URL(Commons.URL_ROOT + Commons.URL_JOURNEY_PLAN);
