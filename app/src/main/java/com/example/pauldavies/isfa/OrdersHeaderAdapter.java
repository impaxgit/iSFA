...
public class OrdersHeaderAdapter extends BaseExpandableListAdapter
{
   ...
   DB db;
    ...
    {
        return orders.get(groupPosition).OrderDetails.size();
    }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent)
    {
        ...
        viewGroupHolder.orderId.setText(orders.get(groupPosition).OrderDate);
        viewGroupHolder.date.setText(orders.get(groupPosition).OrderId);
        if(isExpanded)
        {
            viewGroupHolder.imageView.setImageResource(R.drawable.minimise);
        }
        else
        {
            viewGroupHolder.imageView.setImageResource(R.drawable.expand_more);
        }
    ...
    public View getChildView(final int groupPosition, int childPosition, boolean isLastChild, View convertView, final ViewGroup parent)
    {
        ...
        viewChildHolder.amount.setText(orders.get(groupPosition).OrderDetails.get(childPosition)[0]+"/=");
    ...
    class ViewGroupHolder
    {
        ...
        {
            orderId    =   view.findViewById(R.id.OrderHeaders_txtOrderId);
            date       =   view.findViewById(R.id.OrderHeaders_txtDetailsOrderId);
