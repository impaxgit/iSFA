...
public class GetOrdersLines extends AsyncTask<String,Void,String>
{
    ...
    public GetOrdersLines(AsyncTaskDelegate delegate)
    {
    ...
    protected String doInBackground(String... strings)
    {
        ...
        try
        {
            url  =   new URL(Commons.URL_ROOT+Commons.URL_GET_ORDERSLINES);
            ...
            String params   =   new Uri.Builder()
                                .appendQueryParameter("header", strings[0])
