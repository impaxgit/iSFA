...
public class GetFeedbackTypes extends AsyncTask<String, Void, String>
{
    URL url;
    ...
    public GetFeedbackTypes(AsyncTaskDelegate asyncTaskDelegate)
    {
    ...
    protected String doInBackground(String... strings)
    {
        ...
        try {
            url =   new URL(Commons.URL_ROOT+Commons.URL_GET_FEEDBACK_TYPE);
